...
write.table(seq.tgt_mix1,sprintf("script/target/output/%s/5a_train_mix1_%s.txt",version_id,version_id),
            row.names = F, col.names = F, sep = " ")

write.table(seq.tgt_mix2,sprintf("script/target/output/%s/5b_train_mix2_%s.txt",version_id,version_id),
            row.names = F, col.names = F, sep = " ")
