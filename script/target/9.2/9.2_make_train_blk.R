...
seq_lrn <- read.csv("script/target/output/part/0_train_low_z_3.5_lrn_9.2.txt", header = F, sep=" ")
seq_nlrn <- read.csv("script/target/output/part/0_train_low_z_3.5_nlrn_9.2.txt", header = F, sep=" ")
