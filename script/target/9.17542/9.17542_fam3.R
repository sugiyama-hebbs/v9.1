...
ph0 = 60 # trials in phase 0 (Familiarization/Pre-training)
...
# hard code
s_tri <- c(seq(1,9,2),seq(21,29,2),seq(41,49,2)) + 10
m_tri <- s_tri+1
...
# show_arc[1:(ph0-10)] <- 7 # genuine target
# show_arc[(ph0-9):ph0] <- 6 # clamp target
