...
# 11 = show_arc: whether to present an arc instead of a point target. 2 will remove the arc at movement initiation. 3 will give aiming markers on the sides. 4 will give a target jumping to the cursor direction
