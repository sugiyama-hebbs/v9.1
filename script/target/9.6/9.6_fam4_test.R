...
cond <- "fam_4_test" # condition. Also the main part of filename
pre_tag <- ""
pos_tag <- ""
...
rot_pattern_tmp <- c(3,-3,3,-7,5,-3,7,-5,7,-5,5,-7,    
                     3,-7,5,-3,5,-5,7,-3,7,-5,3,-7,
                     5,7,-5,3,-7,-3) 

rot_degree <- rep(rot_pattern_tmp,num_tri/length(rot_pattern_tmp))

difficulty <- abs(1/7*1/2*rep(rot_pattern_tmp,num_tri/length(rot_pattern_tmp)))
