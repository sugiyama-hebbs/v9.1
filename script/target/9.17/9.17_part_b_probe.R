...
set.seed(27) # Set a fix seed so that a sequence can be replicated 3

#### Set key values & parameters ####
## Filename
version_id = "9.17" # version id
...
num_rot_tri <- 10
clamp_tri <- c(16:25,(pre_rot+num_rot_tri+1):num_tri) # control trials where cursor is clamped
...
tmod_v <- seq(-12,12,3) # c(-10,0,10) # set of modification values on target direction
