...
seq_lrn <- read.csv("script/target/output/part/0_train_low_z_5_lrn_9.22.txt", header = F, sep=" ")
seq_nlrn <- read.csv("script/target/output/part/0_train_low_z_5_nlrn_9.22.txt", header = F, sep=" ")
seq_strat <- read.csv("script/target/output/part/0_train_low_z_5_strat_9.22.txt", header = F, sep=" ")
...
write.table(seq.tgt_lrn,sprintf("script/target/output/train_lrn_9.22.txt"),
            row.names = F, col.names = F, sep = " ")

write.table(seq.tgt_nlrn,sprintf("script/target/output/train_nlrn_9.22.txt"),
            row.names = F, col.names = F, sep = " ")
