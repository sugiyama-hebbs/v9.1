...
set.seed(31) # Set a fix seed so that a sequence can be replicated 11

#### Set key values & parameters ####
## Filename
version_id = "9.162" # version id
...
rot_pattern <- c(rep(0,pre_genuine),rep(1,10),rep(0,15)) # apply rotation on last 20 trials (10 cycles), whatever precedes them will be "washouts" (no rotation) 
