...
# Additional script for making tgt files for reward condition (GW and NW)
...
conds <- c("fam1","fam2b","fam2a","fam2c","rwd_based_pr","norwd","ga","na","visuo_rot","rwd_based")
blk_tags <- c(1,2,3,4,5,6,7,7,10,11)
