...
cond <- "probe_part_test_3.5_5_rot" # condition. Also the main part of filename
pre_tag <- ""
pos_tag <- ""
...
rot_pattern <- c(rep(0,10),rep(1,5),rep(0,5)) # apply rotation on last 20 trials (10 cycles), whatever precedes them will be "washouts" (no rotation) 
