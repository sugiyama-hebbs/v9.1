## Generate a sequence file (.tgt) for v9.1
# First familiarization with wider tgt range 
#
...
blk_tag <- 1 # block tag
cond <- "null_wide" # condition. Also the main part of filename
pre_tag <- ""
pos_tag <- ""
...
tmod_v <- seq(-30,30,3) # set of modification values on target direction
