...
cond <- "train_low_z_3.5_te" # condition. Also the main part of filename
pre_tag <- ""
pos_tag <- ""
...
s_tri <- rep(c(1,0,rep(1,5)),cpb_te_9.14) # flag s trial
m_tri <- rep(c(0,1,rep(0,5)),cpb_te_9.14) # flag m trial
