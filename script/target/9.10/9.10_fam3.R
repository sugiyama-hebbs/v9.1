...
num_cycle_to_extract <- 10
tpc_9.8 <- 2 # trials per cycle

# some hard coding. Be careful about the number of trials to be included/removed
seq_lrn_last <- seq_lrn[(num_train_tri - num_cycle_to_extract*tpc_9.8 + 1):num_train_tri, ]
seq_lrn_last[seq(2,num_cycle_to_extract*tpc_9.8,2),13] <- 2
