...
cond <- "probe_multitgt" # condition. Also the main part of filename
pre_tag <- ""
pos_tag <- ""
...
rot_pattern <- c(rep(0,(ph6-20)),rep(c(1,0),10)) # apply rotation on last 20 trials (10 cycles), whatever precedes them will be "washouts" (no rotation) 
# initialize
