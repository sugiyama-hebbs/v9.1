...
template_rot <- c(2,-2,2,-6,4,-2,6,-4,6,-4,4,-6,    
                  2,-6,4,-2,4,-4,6,-2,6,-4,2,-6)

rot_pattern <- rep(template_rot, cpb_te_9.28/24)

difficulty_pattern <- abs(1/6*1/2*rep(template_rot, cpb_te_9.28/24))
...
difficulty_nlrn <- difficulty # * 1.5
