...
cond <- "a_1s" # condition. Also the main part of filename
pre_tag <- ""
pos_tag <- ""
...
s_tri_length <- rep(1,6) # its mean should be an integer
m_tri_length <- rep(1,6) # its mean should be an integer
