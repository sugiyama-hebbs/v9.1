...
s_tri <- rep(c(rep(1,spc_te_9.12),rep(0,mpc_te_9.12)),cpb_te_9.12) # flag s trial
m_tri <- rep(c(rep(0,spc_te_9.12),rep(1,mpc_te_9.12)),cpb_te_9.12) # flag m trial

rot_pattern <- 1 # single rotation

num_tri <- (spc_te_9.12+mpc_te_9.12)*cpb_te_9.12
...
rot_degree[seq(spc_te_9.12,num_tri,(spc_te_9.12+mpc_te_9.12))] <- rot_size*rot_pattern
show_arc[s_tri == 1] <- 6
show_arc[m_tri == 1] <- 5
show_cur[s_tri == 1] <- 2
