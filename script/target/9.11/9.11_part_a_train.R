...
s_tri <- rep(c(rep(1,spc_te_9.11),rep(0,mpc_te_9.11)),cpb_te_9.11) # flag s trial
m_tri <- rep(c(rep(0,spc_te_9.11),rep(1,mpc_te_9.11)),cpb_te_9.11) # flag m trial

rot_pattern <- rep(c(rep(1,cpb_te_9.11/4),rep(-1,cpb_te_9.11/4),rep(1,cpb_te_9.11/4),rep(-1,cpb_te_9.11/4)),
                   cpb_te_9.11/16) # z ~ 0.1

num_tri <- (spc_te_9.11+mpc_te_9.11)*cpb_te_9.11
