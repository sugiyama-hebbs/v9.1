...
# This includes 0 washout trials as "initial" trial.
...
organize_data_for_fit_zerowo <- function(soi,boi, pre_pos = "pos"){
  ...
  source("script/ind_process/lsse_fit_param_zerowo.R")
